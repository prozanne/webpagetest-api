...
function listen(local, options, callback) {
  WebPageTest.defaultListenPort = 2020;
  callback = callback || options;
  options = options === callback ? {} : options;
...
WebPageTest.defaultServer = 'http://10.89.1.38';
WebPageTest.defaultListenPort = 80;
WebPageTest.defaultWaitResultsPort = 80;
